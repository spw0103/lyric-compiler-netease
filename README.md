...
Link: [spw0103.github.io/lyric-creater](https://spw0103.github.io/lyric-creater)
...
-  **YouTube 備援** — 若網易雲歌詞過短或為空，自動改用 YouTube 影片描述
-  **拖曳排序** — 拖拽調整歌曲順序
-  **生成 Word** — 輸出 .docx，包含：
  - 封面頁
  - 可點擊目錄（頁碼）
...
-  **來源標記** — 每首歌顯示「網易雲」或「YouTube」來源標籤

---

 使用方式

1. 開啟 (https://spw0103.github.io/lyric-creater) 或直接下載本 repo 在瀏覽器打開 `index.html`
